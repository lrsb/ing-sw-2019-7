...
import static it.polimi.ingsw.common.models.Cell.Color.YELLOW;
...
class GameImplTest {
    ...
    class TypeCell {
        ...
        void setCharacter(@NotNull Character character) {
            this.character = character;
            this.color = Cell.Color.WHITE.escape();
        }

        void setAll(@NotNull Character character, @NotNull String color) {
            this.color = color;
            this.character = character;
        }
    ...
    class GameCli {
        TypeCell[][] buildBoard(@NotNull Game game) {
                ...
                if (cell.isSpawnPoint()) {
                    ...
                    if (cell.getAmmoCard() != null) {
                        switch (cell.getAmmoCard().getRight()) {
                            ...
                            case YELLOW: {
                                cellCli[3][6].setAll('Y', YELLOW.escape());
                                break;
                            }
                        }
                    }
